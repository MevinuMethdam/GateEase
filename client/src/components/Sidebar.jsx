...
import { LayoutDashboard, Building, Users, CreditCard, Wrench, Calendar, ShieldCheck, LogOut, Settings, X } from 'lucide-react';
...
const Sidebar = ({ isOpen, setIsOpen }) => {
    ...
    const menuItems = [
        ...
        { icon: Building, label: 'Manage Rooms', path: '/admin/rooms' },
        ...
        { icon: ShieldCheck, label: 'Gate Security', path: '/security' },
