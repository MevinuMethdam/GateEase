...
const MyBookings = () => {
    ...
    const fetchBookings = async () => {
        ...
        try {
            ...
            console.log("Resident Bookings Data:", response.data);
    ...
    const handleSubmit = async (e) => {
        ...
        if (userStatus === 'inactive') {
            return alert("Your account is deactivated. You cannot book facilities.");
        }
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                <div className="lg:col-span-1 bg-[#0A0A0A]/90 backdrop-blur-2xl p-8 rounded-[32px] border border-white/[0.05] h-fit shadow-[0_15px_40px_rgba(0,0,0,0.5)]">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                        ...
                        <div>
                            ...
                            <div className="relative group/input">
                                ...
                                <select value={formData.facility_name} onChange={(e) => setFormData({ ...formData, facility_name: e.target.value })}
                                        ...
                                        className="w-full bg-[#111111] text-[#EAEAEA] pl-12 pr-4 py-4 rounded-[20px] border border-white/[0.05] focus:outline-none focus:border-[#C0DE1B]/50 focus:ring-1 focus:ring-[#C0DE1B]/50 appearance-none cursor-pointer shadow-inner font-bold transition-all tracking-tight disabled:opacity-50">
                        ...
                        <div>
                            ...
                            <div className="relative group/input">
                                ...
                                <input
                                    ...
                                    className={`w-full bg-[#111111] text-[#EAEAEA] pl-12 pr-4 py-4 rounded-[20px] border focus:outline-none cursor-pointer shadow-inner font-medium transition-all disabled:opacity-50 ${formErrors.booking_date ? 'border-red-500/50 focus:ring-1 focus:ring-red-500/50' : 'border-white/[0.05] focus:border-[#C0DE1B]/50 focus:ring-1 focus:ring-[#C0DE1B]/50'}`}
                                />
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full bg-[#111111] text-[#EAEAEA] px-4 py-4 rounded-[20px] border focus:outline-none cursor-pointer shadow-inner font-medium transition-all text-sm disabled:opacity-50 ${formErrors.start_time || formErrors.time ? 'border-red-500/50 focus:ring-1 focus:ring-red-500/50' : 'border-white/[0.05] focus:border-[#C0DE1B]/50 focus:ring-1 focus:ring-[#C0DE1B]/50'}`}
                                />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full bg-[#111111] text-[#EAEAEA] px-4 py-4 rounded-[20px] border focus:outline-none cursor-pointer shadow-inner font-medium transition-all text-sm disabled:opacity-50 ${formErrors.end_time || formErrors.time ? 'border-red-500/50 focus:ring-1 focus:ring-red-500/50' : 'border-white/[0.05] focus:border-[#C0DE1B]/50 focus:ring-1 focus:ring-[#C0DE1B]/50'}`}
                                />
                        ...
                        {userStatus === 'inactive' ? (
                            <button type="button" disabled className="w-full bg-red-500/10 border border-red-500/30 text-red-500 font-extrabold py-4 rounded-[20px] flex items-center justify-center gap-2 mt-6 cursor-not-allowed">
                            ...
                            <button type="submit" className="w-full bg-gradient-to-r from-[#C0DE1B] to-[#9EBA11] text-[#050505] font-extrabold py-4 rounded-[20px] flex items-center justify-center gap-2 mt-6 transition-all duration-300 shadow-[0_0_20px_rgba(192,222,24,0.3)] hover:shadow-[0_0_30px_rgba(192,222,24,0.5)] hover:-translate-y-1">
                                <Plus className="w-5 h-5" /> Request Reservation
                            </button>
                        )}
                    </form>
                </div>
                                ...
                                <tr key={bk.id} className="border-b border-white/[0.02] hover:bg-white/[0.02] transition-colors">
                                    ...
                                    <td className="py-5">
                                        <div className="flex flex-col items-start gap-1">
                                            ...
                                            {bk.status === 'rejected' && bk.rejection_reason && bk.rejection_reason.trim() !== '' && (
                                                <div className="bg-red-500/10 border border-red-500/20 px-2.5 py-1.5 rounded-lg mt-1.5">
                                                    <p className="text-[10px] text-red-400 font-bold flex items-start gap-1">
                                                        <AlertCircle className="w-3 h-3 shrink-0 mt-0.5"/>
                                                        <span>Reason: <span className="italic">{bk.rejection_reason}</span></span>
                                                    </p>
                                                </div>
                                            )}
